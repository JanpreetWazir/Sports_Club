...
const OurTeam = forwardRef((props, ref) => {
    ...
    return (
      <div ref={ref} className="flex flex-col justify-between items-center">
        <h2 className="text-[50px]  font-bold  text-center gradient-text event_section_heading  mt-5 text-black">Board</h2>

        <div className="flex flex-row justify-between text-white gap-2 mt-5">
          <button
            className={`rounded-md px-4 py-2 ${ourTeam === 1 ? 'bg-green' : 'bg-black'
              } hover:bg-black-600 transition duration-300 ease-in-out`}
